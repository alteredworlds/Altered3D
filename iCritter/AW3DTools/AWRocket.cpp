...
int											
AWRocketController::calcTransform(double t, const AWMatrix4& parentTM)
{
    double deltaT = (getLastUpdate() > 0.0) ? t - getLastUpdate() : 0.0;
    ...
    return 1;
}//int AWRocketController::calcTransform( ... )
