...
int						
AWBoidController::calcTransform(double t, const AWMatrix4& parentTM)
{	//the member data for PRS will have been updated by the draw thread
	...
	return 1;
}//int AWBoidController::calcTransform(double t, const AWMatrix4& parentTM)
