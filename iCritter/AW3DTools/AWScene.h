...
public:
   ...
   void              update(float viewZoom, double time);
   void              calcTextures(double t);
   ...
   void		         addBackground(const AWPoint& col, float t)	
	...
	double		         getLoopTime()					{return m_loopTime;}
	void		         setLoopTime(double loopTime)		{m_loopTime=loopTime;}
