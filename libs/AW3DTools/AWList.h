...
#ifdef _WIN32
   friend AWFile& operator>>(AWFile& file, AWList<Type>& obj);
   friend AWFile& operator<<(AWFile& file, AWList<Type>& obj);
   friend AWFile& operator>>(AWFile& file, AWList<Type>*& obj);
   friend AWFile& operator<<(AWFile& file, const AWList<Type>* obj);
#else
   friend AWFile& operator>><>(AWFile& file, AWList<Type>& obj);
   friend AWFile& operator<<<>(AWFile& file, const AWList<Type>& obj);
   friend AWFile& operator>><>(AWFile& file, AWList<Type>*& obj);
...
template <class Type>
AWList<Type>::AWList(int s, int ownsData) : m_ownsData(ownsData)
{
	m_num      = 0;
	m_size     = 0;
	m_element  = NULL;
