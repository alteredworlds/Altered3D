...
int					
AWSeaObject::getFog(float t, const AWSolidCone& viewCone)
...
int
AWSeaObject::calcViewDependentData(float t, const AWSolidCone& viewCone)
{
	...
	return 1;
}//int AWSeaObject::calcViewDependentData(float t, const AWSolidCone& viewCone)
