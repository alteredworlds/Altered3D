...
public:
   ...
   virtual void			calc(float time, AWBoolean loop=TRUE){;}
   virtual int			   getTextureID()             {return m_texID;}
	virtual AWTexture*	getTexture(float time)		{return this;}
   ...
   float			         m_time;	      //validity start time for texture
