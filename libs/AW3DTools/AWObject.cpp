...
AWObject::AWObject(const AWCString& name, AWNode* parent, float life) :
...
void	
AWObject::init(float t, GLRenderer& renderer)
{
...
void
AWObject::calcViewDependentMesh(float time, const AWSolidCone& viewCone)
{
   if (m_curMesh)
   {
...
int	 
AWObject::calcViewDependentData(float t, const AWSolidCone& viewCone)
{
...
int
AWObject::calcVisibility(float t, const AWSolidCone& viewCone)
{
   //call base class method - takes care of the children
...
AWBoolean
AWObject::collideWith(AWObject* target, float time)
{
