...
AWDEFINE_VERSIONABLE_PERSISTABLE(AWTexture, CLSID_AWGLTEXTURE, VER_GLTEXTURE_8);
...
#ifdef __AWTRACE
static char* targetStr[] = {"GL_TEXTURE_1D", "GL_TEXTURE_2D", "GL_TEXTURE_3D_EXT", "GL_TEXTURE_CUBE_MAP_ARB", "UNKNOWN"};
