...
{
	//don't bother assigning the matrix, as this is recalculated
...
int							
AWTransformController::calcTransform(float t, const AWMatrix4& parentTM)
{
	...
	return 1;
}//int AWTransformController::calcTransform(float t, const AWMatrix4& parentTM)


void      
AWTransformController::dumpKeys()
{  //only dumps Quat keys as yet.
   m_rotn.dumpKeys();
