...
MODEL=- 
CFLAGS=-DPNG_USE_PNGVCRD -Ox -GA3s -nologo -W3 -I..\zlib -I"C:\Program Files\Microsoft Visual Studio\VC98\Include"
...
all: libpng.lib png.dll libpng.a
...
png.dll: $(OBJS1) $(OBJS2) $(OBJS3)
	link /dll /def:libpng.def /nodefaultlib /out:png.dll $(OBJS1) $(OBJS2) $(OBJS3) $(LFLAGS) msvcrt.lib ..\zlib\zlib.lib kernel32.lib

libpng.a: png.dll
	dlltool -D png.dll -d libpng.def -l libpng.a
